...
function getPointGen() {
	...
	if (hasUpgrade('s', 94)) gain = gain.pow(1.4)
	if (hasUpgrade('m', 21)) gain = gain.pow(1.2)
	if (hasUpgrade('m', 22)) gain = gain.pow(1.2)
	if (hasUpgrade('m', 23)) gain = gain.pow(1.3)
	if (hasUpgrade('m', 24)) gain = gain.pow(1.25)
	if (hasUpgrade('m', 25)) gain = gain.pow(1.5)
	if (hasAchievement('a', 145)) gain = gain.pow(1.29)
	...
	if (inChallenge("m", 11)) {
		if (hasMilestone("basic", 4)) gain = gain.pow(1.5)
		if (hasMilestone("sac", 10)) gain = gain.pow(1.5)
